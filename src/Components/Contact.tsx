            ...
            {isGreek() ? (
              <div>
                ...
                <ul>
                  <li>
                    <a
                      href={`${process.env.PUBLIC_URL}/thergiakis-eftichios_cv_GR.pdf`}
                      download
                    >
                      PDF
                    </a>
                  ...
                  <li style={{ marginBottom: "120px" }}>
                    {" "}
                    <a
                      href={`${process.env.PUBLIC_URL}/thergiakis-eftichios_cv_GR.docx`}
                      download
                    >
                      Word
                    </a>
              ...
              <div>
                ...
                <ul>
                  <li>
                    <a
                      href={`${process.env.PUBLIC_URL}/thergiakis-eftichios_cv_EN.pdf`}
                      download
                    >
                      PDF
                    </a>
                  ...
                  <li style={{ marginBottom: "120px" }}>
                    {" "}
                    <a
                      href={`${process.env.PUBLIC_URL}/thergiakis-eftichios_cv_EN.docx`}
                      download
                    >
                      Word
                    </a>
