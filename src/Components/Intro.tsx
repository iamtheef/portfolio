    ...
    <div className="container">
      ...
      {!isGreek() ? (
        ...
        <div>
          ...
          <p className="paragraph" style={{ marginTop: "23px" }}>
            Ονομάζομαι Θεργιάκης Ευτύχιος, έχω γενηθεί και μεγαλώσει στο νησί
            της Κρήτης στην Ελλάδα. Είμαι {new Date().getFullYear() - 1994}{" "}
            χρονών. Είμαι ευφευρετικός, αυτοδίδακτος, εργατικός και μαθαίνω
            γρήγορα. Ευέλικτος και ομαδικός. Ψάχνω μία θέση στον τομέα ανάπτυξης
            εφαρμογών όπου η εμπειρία και οι δεξιότητες μου θα προσφέρουν στο
            τελικό αποτέλεσμα, καθώς θα μου επιτρέπει να επεκτείνω τις
            δυνατότητες και τις γνώσεις μου στον τομέα του software. Με
